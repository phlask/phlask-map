...
const SvgPinWaterDefault = ({ title, titleId, ...props }, ref) => (
  <svg
  ...
  >
    ...
    <g filter="url(#PinWaterDefault_svg__a)">
      <path
        fill="#fff"
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_568_38814"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect1_dropShadow_568_38814"
          result="shape"
        />
      </filter>
    </defs>
...
const ForwardRef = forwardRef(SvgPinWaterDefault);

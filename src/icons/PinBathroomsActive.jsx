...
const SvgPinBathroomsActive = ({ title, titleId, ...props }, ref) => (
  <svg
  ...
  >
    ...
    <g filter="url(#PinBathroomsActive_svg__a)">
      <path
        fill="#9E9E9E"
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_568_38828"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect1_dropShadow_568_38828"
          result="shape"
        />
      </filter>
    </defs>
...
const ForwardRef = forwardRef(SvgPinBathroomsActive);

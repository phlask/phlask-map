export const waterConfig = {
  ...
  databaseURL: 'https://phlask-web-map-prod-water-live.firebaseio.com', // https://phlask-web-map.firebaseio.com
...
export const foodConfig = {
  apiKey: 'AIzaSyABw5Fg78SgvedyHr8tl-tPjcn5iFotB6I',
  authDomain: 'phlask-web-map.firebaseapp.com',
  databaseURL: 'https://phlask-web-map-prod-food-live.firebaseio.com', // https://phlask-web-map-food-updated.firebaseio.com/
  projectId: 'phlask-web-map',
  storageBucket: 'phlask-web-map.appspot.com',
  messagingSenderId: '428394983826'
};

...
const Acknowledgements = () => {
  return (
    <div className={styles.pageText}>
      ...
      <p>
        The PHLASK Acknowledgements is simple: expand accessibility to water and reduce
        waste associated with distribution.
      </p>
      <p>
        Water should remain abundant, clean and accessible to everyone.
        PHLASK&apos;s Acknowledgements is to help people find publicly available
      ...
      <p>
        ...
        faith that proprietors who ideologically agree with the Acknowledgements would

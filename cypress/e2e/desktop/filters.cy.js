...
describe("Foraging resource filtering", () => {
  ...
  it("should filter forage sites by forage type", () => {
    let initialCount;
    getResourceCount().then(count => {
      initialCount = count;
      expect(initialCount).to.be.greaterThan(0);
  ...
  it("should restore forage sites when Clear All is clicked after filtering by forage type", () => {
    let initialCount;
    getResourceCount().then(count => {
      initialCount = count;
      expect(initialCount).to.be.greaterThan(0);
  ...
  it("should filter forage sites by features", () => {
    let initialCount;
    getResourceCount().then(count => {
      initialCount = count;
      expect(initialCount).to.be.greaterThan(0);
  ...
  it("should restore forage sites when Clear All is clicked after filtering by features", () => {
    let initialCount;
    getResourceCount().then(count => {
      initialCount = count;
      expect(initialCount).to.be.greaterThan(0);
  ...
  it("should filter forage sites by multiple criteria", () => {
    let initialCount;
    getResourceCount().then(count => {
      initialCount = count;
      expect(initialCount).to.be.greaterThan(0);
  ...
  it("should restore forage sites when Clear All is clicked after filtering by multiple criteria", () => {
    let initialCount;
    getResourceCount().then(count => {
      initialCount = count;
      expect(initialCount).to.be.greaterThan(0);
